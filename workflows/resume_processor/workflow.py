...
class ResumeProcessorWorkflow:
    def __init__(
        ...
        self.absolute_rating = AbsoluteRatingNode(self.llm)
    ...
    def _create_workflow(self) -> StateGraph:
        ...
        # Add edges
        workflow.add_edge("jd_analysis", "router")
        workflow.add_edge("router", "cultural_agent")
        workflow.add_edge("cultural_agent", "absolute_rating")
        workflow.add_edge("absolute_rating", END)
